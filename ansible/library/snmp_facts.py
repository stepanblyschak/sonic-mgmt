...
class DefineOid(object):
    ...
    def __init__(self,dotprefix=False):
        ...
        self.entPhySensorType           = dp + "1.3.6.1.2.1.99.1.1.1.1.1"
        self.entPhySensorScale          = dp + "1.3.6.1.2.1.99.1.1.1.1.2"
        self.entPhySensorPrecision      = dp + "1.3.6.1.2.1.99.1.1.1.1.3"
        self.entPhySensorValue          = dp + "1.3.6.1.2.1.99.1.1.1.1.4"
        self.entPhySensorOperStatus     = dp + "1.3.6.1.2.1.99.1.1.1.1.5"
...
def main():
    ...
    errorIndication, errorStatus, errorIndex, varTable = cmdGen.nextCmd(
        ...
        cmdgen.MibVariable(p.entPhysSensorOperStatus,),
    )
